...
const UpdateParcel = () => {
    ...
    const { weight, officeID, officeName, customerID, customerName, transportMethod, destinationID, destinationName, tagID, tagName, estimateArrival, description, mixedPackage, whatsappNotif, pricePerKilo, actualCarrierCost, paymentStatus, status, createdBy, partialAmount, packagePictures } = data;
    ...
    const { data: parcelData, isLoading } = getSingleParcelAPI;
